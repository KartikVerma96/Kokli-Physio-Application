...
/**
 * "1 treatment", "3 treatments".
 *
 * A new clinic starts with one of everything — one treatment, one patient — so
 * a count with a hard-coded plural reads wrong on exactly the pages a first-time
